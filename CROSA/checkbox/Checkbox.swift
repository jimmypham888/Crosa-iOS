...
public class Checkbox: UIControl {
    ...
    ///
    /// **Default:** `2`
    public var borderCheckWidth: CGFloat = 2
    ...
    private func drawBorder(shape: BorderStyle, in rect: CGRect) {
        let adjustedRect = CGRect(x: borderCheckWidth/2,
                                  y: borderCheckWidth/2,
    ...
    private func squareBorder(rect: CGRect) {
        ...
        rectanglePath.lineWidth = borderCheckWidth
    ...
    private func circleBorder(rect: CGRect) {
        ...
        ovalPath.lineWidth = borderCheckWidth / 2
        ovalPath.stroke()
        checkboxBackgroundColor.setFill()
        ovalPath.fill()
    }
